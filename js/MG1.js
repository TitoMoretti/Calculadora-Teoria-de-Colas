document.addEventListener('DOMContentLoaded', () => {
    ...
    function clearResults() {
        [
            'result-muN', 'result-esN', 'result-rhoN', 'result-enN', 'result-etN', 'result-varN'
        ].forEach(id => {
    ...
    function displayResults(results) {
        ...
        document.getElementById('result-varN').textContent = formatNumber(results.varianza, false);
